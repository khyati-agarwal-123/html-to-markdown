[Previous](load-character-vector-data-using-sqlloader-example.html) [Next](unload-and-load-vectors-using-oracle-data-pump.html) JavaScript must be enabled to correctly display this content 
...
**Parent topic:** [Load Vector Data Using SQL*Loader](load-vector-data-using-sqlloader.html "Use these examples to understand how you can load character and binary vector data.")
