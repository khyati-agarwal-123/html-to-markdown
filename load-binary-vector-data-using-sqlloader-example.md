[Previous](load-character-vector-data-using-sqlloader-example.html)[Next](unload-and-load-vectors-using-oracle-data-pump.html) JavaScript must be
...
sqlloader.html "Use these examples to understand how you can load character
