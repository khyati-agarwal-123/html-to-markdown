[Previous](cosine_distance.html) [Next](hamming_distance-vecse.html) JavaScript must be enabled to correctly display this content 
...
![Description of inner_product.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/inner_product.gif)[Descriptionof the illustration inner_product.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/inner_product.html)
