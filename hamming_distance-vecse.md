[Previous](inner_product.html) [Next](jaccard_distance-vecse.html) JavaScript must be enabled to correctly display this content 
...
![Description of hamming_distance_syntax.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/hamming_distance_syntax.gif)[Descriptionof the illustration hamming_distance_syntax.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/hamming_distance_syntax.html)
