[Previous](optimizer-plans-vector-indexes.html) [Next](optimizer-plans-ivf-vector-indexes.html) JavaScript must be enabled to correctly display this content 
