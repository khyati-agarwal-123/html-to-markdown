[Previous](enable_checkpoint.html) [Next](index_accuracy_query.html)
...
Specify the name of the vector index. You can query the index creation status
for both Hierarchical Navigable Small World (HNSW) indexes and Inverted File
Flat (IVF) indexes.
