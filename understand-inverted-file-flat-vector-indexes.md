[Previous](neighbor-partition-vector-indexes.html) [Next](inverted-file-flat-vector-indexes-partitioning-schemes.html) JavaScript must be enabled to correctly display this content 
...
![Description of Figure 6-6 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/inverted-file-index_1.png)[Descriptionof "Figure 6-6 Inverted File Flat Index Using 2D"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/inverted-file-index_1.html)
...
![Description of Figure 6-7 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/inverted-file-index_5.png)[Descriptionof "Figure 6-7 Inverted File Flat Index"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/inverted-file-index_5.html)
...
![Description of Figure 6-8 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/inverted-file-index_6.png)[Descriptionof "Figure 6-8 Inverted File Flat Index"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/inverted-file-index_6.html)

  


For a query vector `vq`â, the search algorithm identifies the nearest `i` centroids, where `i` defaults to the square root of `k` but can be adjusted for a specific query by setting the `NEIGHBOR PARTITION PROBES` parameter. This adjustment allows for a trade-off between search speed and accuracy. 
...
![Description of Figure 6-9 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/inverted-file-index_7.png)[Descriptionof "Figure 6-9 Inverted File Flat Index"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/inverted-file-index_7.html)
...
This method constitutes an approximate search as it limits the search to a subset of partitions, thereby accelerating the process but potentially missing closer vectors in unexamined partitions. This example illustrates that an approximate search might not yield the exact nearest vectors to `vq`â, demonstrating the inherent trade-off between search efficiency and accuracy. 
...
![Description of Figure 6-10 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/inverted-file-index_10.png)[Descriptionof "Figure 6-10 Inverted File Flat Index"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/inverted-file-index_10.html)
...
![Description of Figure 6-11 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/inverted-file-index_11.png)[Descriptionof "Figure 6-11 Inverted File Flat Index"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/inverted-file-index_11.html)
...
![Description of Figure 6-12 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/inverted-file-index_12.png)[Descriptionof "Figure 6-12 Inverted File Flat Index"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/inverted-file-index_12.html)
...
**Parent topic:** [About Neighbor Partition Vector Index](neighbor-partition-vector-indexes.html "The default type of index created for a Neighbor Partition vector index is Inverted File Flat.")
