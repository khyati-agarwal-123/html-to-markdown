[Previous](utl_to_chunks-dbms_vector.html) [Next](utl_to_generate_text-dbms_vector.html) JavaScript must be enabled to correctly display this content
...
Use the `DBMS_VECTOR.UTL_TO_EMBEDDING` and `DBMS_VECTOR.UTL_TO_EMBEDDINGS`
chainable utility functions to generate one or more vector embeddings from
...
[← Previous](utl_to_chunks-dbms_vector.md)

[Next →](utl_to_generate_text-dbms_vector.md)
