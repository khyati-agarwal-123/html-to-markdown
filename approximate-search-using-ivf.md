[Previous](approximate-search-using-hnsw.html) [Next](perform-multi-vector-similarity-search.html) JavaScript must be enabled to correctly display this content 
  ...
  3. [Perform Approximate Similarity Search Using Vector Indexes](perform-approximate-similarity-search-using-vector-indexes.html)4. [Approximate Similarity Search Examples](approximate-similarity-search-examples.html)
...
**Parent topic:** [Approximate Similarity Search Examples](approximate-similarity-search-examples.html "Review these examples to see how you can perform an approximate similarity search using vector indexes.")
