...
23ai, Release Update 23.6.

WARNING:

If you need to install Database Release Update 23.6.0.24.10, there are
important steps you must follow to properly install this release update.
Please make sure you follow these instructions at [Patch 37037086 - Database
Release Update 23.6.0.24.1](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-
database/23/vecse&id=mos_doc_888_1).
...
**Parent topic:** [Oracle Database 23ai Release Updates](oracle-database-23ai-
release-updates.html "The following sections include new AI Vector Search
features introduced in Oracle Database 23ai as part of the listed Release
Update.")
