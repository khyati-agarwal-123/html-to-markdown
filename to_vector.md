[Previous](vector-constructors.html) [Next](vector1.html) JavaScript must be enabled to correctly display this content 
...
![Description of to_vector_vecse.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/to_vector_vecse.gif)[Descriptionof the illustration to_vector_vecse.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/to_vector_vecse.html)
...
**Parent topic:** [Vector Constructors](vector-constructors.html "TO_VECTOR\(\) and VECTOR\(\) are synonymous constructors of vectors. The functions take a string of type VARCHAR2 or CLOB as input and return a vector as output.")
