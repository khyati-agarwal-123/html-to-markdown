[Previous](l2_distance.html) [Next](inner_product.html) JavaScript must be enabled to correctly display this content 
...
![Description of cosine_distance.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/cosine_distance.gif)[Descriptionof the illustration cosine_distance.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/cosine_distance.html)
