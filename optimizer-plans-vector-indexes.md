[Previous](understand-approximate-similarity-search-using-vector-indexes.html) [Next](optimizer-plans-hnsw-vector-indexes.html) JavaScript must be enabled to correctly display this content 
...
**Parent topic:** [Perform Approximate Similarity Search Using Vector Indexes](perform-approximate-similarity-search-using-vector-indexes.html "For a vector search to be useful, it needs to be fast and accurate. Approximate similarity searches seek a balance between these goals.")
