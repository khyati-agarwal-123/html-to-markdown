[Previous](describe-image-content.html) [Next](describe-images-using-ollama.html) JavaScript must be enabled to correctly display this content
  ...
  3. [Use LLM-Powered APIs to Generate Summary and Text](use-llm-powered-apis-generate-summary-and-text.html)4. [Describe Image Content](describe-image-content.html)
  5. Describe Images Using Public REST Providers
...
To generate a text response by prompting with the following image and the text
question "`Describe this image?`", using an external LLM:

![Description of bird.jpg
follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/bird.jpg)[Description of the illustration
bird.jpg](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/bird.html)
...
Google AI, Hugging Face, OpenAI, and Vertex AI require the following
...
Replace `access_token` and `credential_name` with your own values. For
example:
...
For a list of all supported REST endpoint URLs, see [Supported Third-Party
...
Hugging Face uses an image captioning model, which does not require a prompt.
If you input a prompt along with an image, then the prompt will be ignored.
...
**Related Topics**
  ...
  * [UTL_TO_GENERATE_TEXT](utl_to_generate_text-dbms_vector_chain.html#GUID-017C9002-194C-48E5-B59B-EF5C60BC8405 "Use the DBMS_VECTOR_CHAIN.UTL_TO_GENERATE_TEXT chainable utility function to generate a text response for a given prompt or an image, by accessing third-party text generation models.")
...
**Parent topic:** [Describe Image Content](describe-image-content.html "In
these examples, you can see how to generate a textual analysis or description
of the contents of a given image.")


[← Previous](describe-image-content.md)

[Next →](describe-images-using-ollama.md)
