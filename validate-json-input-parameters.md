[Previous](terms-using-vector-utility-pl-sql-packages.html) [Next](import-pretrained-models-onnx-format-vector-generation-database.html) JavaScript must be enabled to correctly display this content 
