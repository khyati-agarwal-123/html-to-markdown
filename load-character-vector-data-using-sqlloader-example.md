[Previous](load-vector-data-using-sqlloader.html) [Next](load-binary-vector-data-using-sqlloader-example.html) JavaScript must be enabled to correctly display this content 

  1. [AI Vector Search User's Guide](index.html)2. [Store Vector Embeddings](store-vector-embeddings.html)
  3. [Load Vector Data Using SQL*Loader](load-vector-data-using-sqlloader.html)
...
**Related Topics**
  ...
  * [Loading LOB Data from LOBFILEs](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/vecse&id=SUTIL-GUID-E02C2828-ABD1-4B8D-9561-124D221B4BE3)**Parent topic:** [Load Vector Data Using SQL*Loader](load-vector-data-using-sqlloader.html "Use these examples to understand how you can load character and binary vector data.")
