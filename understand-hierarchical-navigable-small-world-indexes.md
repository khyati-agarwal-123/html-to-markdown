[Previous](memory-neighbor-graph-vector-indexes.html) [Next](understand-transaction-support-tables-hnsw-indexes.html) JavaScript must be enabled to
correctly display this content
  ...
  6. Understand Hierarchical Navigable Small World Indexes

## Understand Hierarchical Navigable Small World Indexes

Use these examples to understand how to create HNSW indexes for vector
...
follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/navigable-small-world-graph.png)[Description of "Figure 6-2 Navigable Small World
Graph"](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/navigable-small-world-graph.html)
...
follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/probability-skip-list_01.png)[Description of "Figure 6-3 Probability Skip List
Structure"](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/probability-skip-list_01.html)
...
follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/hierarchical-navigable-small-world-graph_02.png)[Description of "Figure 6-4 Hierarchical Navigable Small World
Graphs"](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/hierarchical-navigable-small-world-graph_02.html)
...
vector set by the `NEIGHBORS` parameter, layer `0` can have twice as much.
...
follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/hnsw-search-graph_02-png.png)[Description of "Figure 6-5 Hierarchical Navigable Small World Graphs
Search"](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/hnsw-search-graph_02-png.html)
...
accuracy at which the approximate search should be performed.

In the case of an HNSW approximate search, you can specify a target accuracy
percentage value to influence the number of candidates considered to probe the
search. This is automatically calculated by the algorithm. A value of 100 will
tend to impose a similar result as an exact search, although the system may
still use the index and will not perform an exact search. The optimizer may
choose to still use an index as it may be faster to do so given the predicates
in the query. Instead of specifying a target accuracy percentage value, you
can specify the `EFSEARCH` parameter to impose a certain maximum number of
candidates to be considered while probing the index. The higher that number,
...
[← Previous](memory-neighbor-graph-vector-indexes.md)

[Next →](understand-transaction-support-tables-hnsw-indexes.md)
