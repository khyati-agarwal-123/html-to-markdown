[Previous](vvector_memory_pool.html) [Next](vecsys-vectorindex.html)
...
These views allow you to query tables related to vector indexes and hybrid
vector indexes.
...
This fixed view provides diagnostic information about Inverted File Flat
