[Previous](oracle-ai-vector-search-statistics.html) [Next](oracle-machine-learning-static-dictionary-views.html) JavaScript must be enabled to correctly
...
search-statistics.html "These are a set of statistics related to Oracle AI
Vector Search.")
