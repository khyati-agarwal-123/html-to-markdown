[Previous](insert-vectors-database-table-using-insert-statement.html) [Next](load-character-vector-data-using-sqlloader-example.html) JavaScript must be enabled to correctly display this content 
