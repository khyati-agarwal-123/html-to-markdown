[Previous](create-vector-indexes-and-hybrid-vector-indexes.html)[Next](manage-different-categories-vector-indexes.html) JavaScript must be
...
to speed up Inverted File Flat (IVF) index creation as well as DML operations
...
follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_pool.png)[Description of "Figure 6-1 Vector
Pool"](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/vector_pool.html)
...
File](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-
...
See Also:
  ...
  * [Vector Memory Pool Views](vector-memory-pool-views.html#GUID-4A5CCD79-4E1E-4E53-93AD-C940C3DFD687 "Review the various vector memory pool views.")
...
[← Previous](create-vector-indexes-and-hybrid-vector-indexes.md)
