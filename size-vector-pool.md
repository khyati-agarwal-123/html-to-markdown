[Previous](create-vector-indexes-and-hybrid-vector-indexes.html) [Next](manage-different-categories-vector-indexes.html) JavaScript must be enabled to correctly display this content 
...
![Description of Figure 6-1 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_pool.png)[Descriptionof "Figure 6-1 Vector Pool"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/vector_pool.html)
...
**Parent topic:** [Create Vector Indexes and Hybrid Vector Indexes](create-vector-indexes-and-hybrid-vector-indexes.html "Depending on whether to use similarity search or hybrid search, you can create either a vector index or a hybrid vector index.")
