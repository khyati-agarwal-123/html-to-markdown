[Previous](convert-text-string-embedding-oracle-database.html) [Next](convert-text-string-embedding-using-public-third-party-apis.html) JavaScript must be
enabled to correctly display this content
  ...
  5. Convert Text String to BINARY Embedding Outside Oracle Database
...
To generate a vector embedding with "`hello`" as the input using Cohere
ubinary embed-english-v3.0 model:
...
Replace `<access token>` with your own values. You will later refer to this
credential name when declaring JSON parameters for the `UTL_TO_EMBEDDING`
call.
...
[← Previous](convert-text-string-embedding-oracle-database.md)

[Next →](convert-text-string-embedding-using-public-third-party-apis.md)
