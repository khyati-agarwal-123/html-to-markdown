[Previous](jaccard-similarity.html) [Next](l1_distance.html) JavaScript must be enabled to correctly display this content 
...
![Description of vector_distance.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_distance.gif)[Descriptionof the illustration vector_distance.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/vector_distance.html)
