[Previous](generate-summary.html) [Next](generate-summary-using-ollama.html)
...
Here, the cohere.command-r-16k model is used. You can replace the `model`
value, as required.
...
Optionally, you can specify additional REST provider-specific parameters. For
example:
...
**Parent topic:** [Generate Summary](generate-summary.html "In these examples,
