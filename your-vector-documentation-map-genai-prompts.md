[Previous](sql-quick-start-using-binary-vector-generator.html) [Next](generate-vector-embeddings-node.html) JavaScript must be enabled to correctly display this content 
...
**Parent topic:** [Get Started](get-started-node.html "To get started, review the steps for the different tasks that you can do with Oracle AI Vector Search.")
