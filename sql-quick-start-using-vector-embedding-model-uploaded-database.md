...
approximate manner. In addition to pure similarity searches, you will create
Hybrid Vector Indexes and use them to run hybrid searches.

See [Overview of Oracle AI Vector Search](overview-ai-vector-
...
query data based on semantics, rather than keywords.") for more introductory
...
As an alternative to the preceding Object Storage instructions, you also have
the option to use the `LOAD_ONNX_MODEL_CLOUD` procedure of the `DBMS_VECTOR`
package to load an ONNX embedding model from cloud Object Storage. For more
information about the procedure, see [Oracle Database PL/SQL Packages and
Types Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-
database/23/vecse&id=ARPLS-GUID-82A8D291-8096-4A7C-8882-9B6AC4A7FCCB).
...
database.html#GUID-D8140BF9-08E9-4B3F-9E28-E40A6FD181A4 "You can download
...
type.html#GUID-E05AC257-CBD6-4B0C-A29F-0116EF02EA3A "You can declare a table's
...
cases.html#GUID-63773EF5-071E-4C02-9EC9-D4E0BA2CE2A2 "These are intended to be
...
Functions to Generate Embeddings](sql-functions-generate-embeddings.html#GUID-
...
operators.html#GUID-8667D062-8084-4E55-8BD7-2C84E05F52FA "A vector distance
...
Similarity Search](perform-exact-similarity-search.html#GUID-
...
search.html#GUID-F5ACF1FB-87C8-4051-872D-63E408480EC8 "Another major use-case
...
and Hybrid Vector Indexes](create-vector-indexes-and-hybrid-vector-
...
Pool](size-vector-pool.html#GUID-1815E227-56C9-4E62-977F-0FDA282C9D83 "To
...
indexes.html#GUID-D8432ADA-38B0-4E5F-975F-E86977CA8488 "For a vector search to
...
indexes.html#GUID-80BBB84C-48F4-4C0B-9137-0B114D5515C9 "Optimizer plans for
...
report.html#GUID-A084929C-7A04-4764-9E5B-1204E0844CAF "The index accuracy
...
For complete `DBMS_HYBRID_VECTOR.SEARCH` syntax information, see
[SEARCH](search.html#GUID-A386BDB0-35D0-41E1-8F41-49AEBEC13BFC "Use the
DBMS_HYBRID_VECTOR.SEARCH PL/SQL function to run textual queries, vector
similarity queries, or hybrid queries against hybrid vector indexes.").
...
Before executing the following statement, replace the rowid value that you got
from running the previous statement.
...
In this step, a lot of parameters were explicitly indicated. However, you can
stick to the defaults and run the following statement instead.
...
To experiment with hybrid vector index maintenance, insert a new row in your
base table and run the same hybrid search query as you did in the previous
step:
