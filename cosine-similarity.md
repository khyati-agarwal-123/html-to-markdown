[Previous](euclidean-and-squared-euclidean-distances.html) [Next](dot-product-similarity.html) JavaScript must be enabled to correctly display this content
...
follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/cosine_similarity_2x2.png)[Description of the illustration
cosine_similarity_2x2.png](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/cosine_similarity_2x2.html)
