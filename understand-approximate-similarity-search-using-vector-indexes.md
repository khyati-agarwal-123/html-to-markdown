[Previous](perform-approximate-similarity-search-using-vector-indexes.html) [Next](optimizer-plans-vector-indexes.html) JavaScript must be enabled to correctly display this content 
...
![Description of accuracy1.png follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/accuracy1.png)[Descriptionof the illustration accuracy1.png](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/accuracy1.html)
...
![Description of accuracy2.png follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/accuracy2.png)[Descriptionof the illustration accuracy2.png](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/accuracy2.html)
...
![Description of accuracy3.png follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/accuracy3.png)[Descriptionof the illustration accuracy3.png](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/accuracy3.html)
...
![Description of accuracy4.png follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/accuracy4.png)[Descriptionof the illustration accuracy4.png](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/accuracy4.html)
