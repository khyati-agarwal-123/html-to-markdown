[Previous](generate-summary-using-public-third-party-apis.html) [Next](generate-text-response.html) JavaScript must be enabled to correctly display this content 
...
[Next →](generate-text-response.md)
