[Previous](generate-text-response.html) [Next](generate-text-locally-ollama.html) JavaScript must be enabled to correctly display this content 
...
For example, for the meta.llama-3-70b-instruct model:
...
**Parent topic:** [Generate Text Response](generate-text-response.html "In these examples, you can see how to generate a textual answer, description, or summary based on the specified task in a given prompt.")

[← Previous](generate-text-response.md)
