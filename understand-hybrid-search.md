...
For the sake of the following explanations, we are using the same use case as seen in [Understand Hybrid Vector Indexes](understand-hybrid-vector-indexes.html#GUID-28C18166-43BB-4D2C-B8B3-8127D3485578 "A hybrid vector index inherits all the information retrieval capabilities of Oracle Text search indexes and leverages the semantic search capabilities of Oracle AI Vector Search vector indexes."): 

![Description of overview_hybrid_vector_index.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/overview_hybrid_vector_index.png)[Descriptionof the illustration overview_hybrid_vector_index.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/overview_hybrid_vector_index.html)
...
![Description of pure_semantic_document_mode_query.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/pure_semantic_document_mode_query.png)[Descriptionof the illustration pure_semantic_document_mode_query.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/pure_semantic_document_mode_query.html)
...
![Description of Figure 8-2 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/keyword_semantic_document_mode_query.png)[Descriptionof "Figure 8-2 Scoring for Keyword and Semantic Search in Document Mode"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/keyword_semantic_document_mode_query.html)
...
![Description of Figure 8-3 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/fuse_operators_doc_mode.png)[Descriptionof "Figure 8-3 Fusion Operation in Document Search Mode"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/fuse_operators_doc_mode.html)
...
![Description of Figure 8-4 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/keyword_semantic_chunk_mode_query.png)[Descriptionof "Figure 8-4 Scoring for Keyword and Semantic Search in Chunk Mode"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/keyword_semantic_chunk_mode_query.html)
...
![Description of Figure 8-5 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/fuse_operators_chunk_mode.png)[Descriptionof "Figure 8-5 Fusion Operation in Chunk Search Mode"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/fuse_operators_chunk_mode.html)
...
**Parent topic:** [Perform Hybrid Search](perform-hybrid-search.html "Hybrid search is an advanced information retrieval technique that lets you search documents by keywords and vectors, to achieve more relevant search results.")
