[Previous](sql-quick-start-using-vector-embedding-model-uploaded-database.html) [Next](sql-quick-start-using-binary-vector-generator.html)
...
follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_clusters.png)[Description of "Figure 3-1 Vector
Clusters"](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/vector_clusters.html)
...
For information about the columns of the `VECSYS.VECTOR$INDEX` view, see
[VECSYS.VECTOR$INDEX](vecsys-vectorindex.html#GUID-
