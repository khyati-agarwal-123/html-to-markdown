[Previous](sql-quick-start-using-vector-embedding-model-uploaded-database.html) [Next](sql-quick-start-using-binary-vector-generator.html) JavaScript must be enabled to correctly display this content 
...
![Description of Figure 3-1 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_clusters.png)[Descriptionof "Figure 3-1 Vector Clusters"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/vector_clusters.html)
...
For information about the columns of the `VECSYS.VECTOR$INDEX` view, see [VECSYS.VECTOR$INDEX](vecsys-vectorindex.html#GUID-FA5183EA-3C60-470D-9C91-8215BE4FF138 "This dictionary table contains detailed information about vector indexes."). 
