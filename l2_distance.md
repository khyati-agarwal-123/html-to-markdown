[Previous](l1_distance.html) [Next](cosine_distance.html) JavaScript must be
...
follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/l2_distance.gif)[Description of the illustration
l2_distance.eps](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/l2_distance.html)
