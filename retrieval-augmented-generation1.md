[Previous](use-retrieval-augmented-generation-complement-llms.html) [Next](sql-rag-example.html) JavaScript must be enabled to correctly display this content 
...
![Description of Figure 9-1 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/chatbot_llm_workflow.png)[Descriptionof "Figure 9-1 Example RAG Workflow"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/chatbot_llm_workflow.html)
