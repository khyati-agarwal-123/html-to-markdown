[Previous](use-retrieval-augmented-generation-complement-llms.html)[Next](sql-rag-example.html) JavaScript must be enabled to correctly display
this content
...
minimize the probability that an LLM will hallucinate.
...
follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/chatbot_llm_workflow.png)[Description of "Figure 9-1 Example RAG
Workflow"](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/chatbot_llm_workflow.html)
