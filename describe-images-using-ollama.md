[Previous](describe-images-using-public-third-party-apis.html) [Next](use-retrieval-augmented-generation-complement-llms.html) JavaScript must be enabled to correctly display this content 
...
![Description of bird.jpg follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/bird.jpg)[Descriptionof the illustration bird.jpg](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/bird.html)
...
For a complete list of all supported REST endpoint URLs, see [Supported Third-Party Provider Operations and Endpoints](supported-third-party-provider-operations-and-endpoints.html#GUID-BE3EE403-CD10-4708-A15F-EFB1FA69DF09 "Review a list of third-party REST providers and REST endpoints that are supported for various vector generation, summarization, text generation, and reranking operations."). 
...
**Parent topic:** [Describe Image Content](describe-image-content.html "In these examples, you can see how to generate a textual analysis or description of the contents of a given image.")
