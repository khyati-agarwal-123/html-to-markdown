[Previous](describe-images-using-public-third-party-apis.html) [Next](use-retrieval-augmented-generation-complement-llms.html) JavaScript must be
enabled to correctly display this content
  ...
  5. Describe Images Using the Local REST Provider Ollama
...
text question as the prompt by accessing open LLMs, using the local host REST
endpoint provider Ollama.

Ollama is a free and open-source command-line interface tool that allows you
to run open LLMs (such as Llama 3, Llava, Phi 3, Mistral, or Gemma 2) locally
and privately on your Linux, Windows, or macOS systems. You can access Ollama
as a service using SQL and PL/SQL commands.
...
To describe the contents of an image, by prompting with the following image of
a bird and the text question "`Describe this image?`", by calling a local LLM
using Ollama:
...
[← Previous](describe-images-using-public-third-party-apis.md)
