[Previous](all_vector_abbrev_tokens.html)[Next](user_vector_abbrev_tokens.html) JavaScript must be enabled to correctly
...
**Parent topic:** [Text Processing Views](text-processing-views.html "These
views display language-specific data \(abbreviation token details\) and
