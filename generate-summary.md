[Previous](use-llm-powered-apis-generate-summary-and-text.html) [Next](generate-summary-using-public-third-party-apis.html) JavaScript must be enabled to correctly display this content 
...
You can also generate a summary using Oracle Database as the service provider. In this case, Oracle Text is internally used to generate a summary. However, that is outside the scope of these examples. See [UTL_TO_SUMMARY](utl_to_summary.html#GUID-EC9DDB58-6A15-4B36-BA66-ECBA20D2CE57 "Use the DBMS_VECTOR_CHAIN.UTL_TO_SUMMARY chainable utility function to generate a summary for textual documents."). 
...
**Parent topic:** [Use LLM-Powered APIs to Generate Summary and Text](use-llm-powered-apis-generate-summary-and-text.html "Run these end-to-end examples to see how you can summarize or describe textual inputs and images.")
