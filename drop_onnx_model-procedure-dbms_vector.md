[Previous](drop_credential-dbms_vector.html) [Next](enable_checkpoint.html)
...
You can use the following command to delete a valid ONNX model named
`doc_model` that exists in your schema.
