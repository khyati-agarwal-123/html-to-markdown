[Previous](vector_dimension_count.html) [Next](vector_dimension_format.html) JavaScript must be enabled to correctly display this content 
...
![Description of vector_dims.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_dims.gif)[Descriptionof the illustration vector_dims.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/vector_dims.html)
