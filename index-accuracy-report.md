[Previous](guidelines-using-vector-indexes.html) [Next](vector-index-status-checkpoint-and-advisor-procedures.html) JavaScript must be enabled to correctly display this content 
...
[Next →](vector-index-status-checkpoint-and-advisor-procedures.md)
