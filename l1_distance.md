[Previous](vector_distance.html) [Next](l2_distance.html) JavaScript must be enabled to correctly display this content 
...
![Description of l1_distance.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/l1_distance.gif)[Descriptionof the illustration l1_distance.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/l1_distance.html)
