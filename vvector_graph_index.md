[Previous](vvector_index.html) [Next](vvector_partitions_index.html) JavaScript must be enabled to correctly display this content 
...
INDEX_GRAPH_TYPE | VARCHAR2(129) | Type of the constructed graph of this index. Possible values: HNSW: Hierarchical Navigable Small Worlds. Currently only this graph is supported.  
...
**Parent topic:** [Vector Index and Hybrid Vector Index Views](vector-index-and-hybrid-vector-index-views.html "These views allow you to query tables related to vector indexes and hybrid vector indexes.")
