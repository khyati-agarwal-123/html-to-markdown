[Previous](your-vector-documentation-map-genai-prompts.html) [Next](vector-generation.html) JavaScript must be enabled to correctly display this content
...
your data, rather than the actual words in a document or pixels in an image
(as explained in [Overview of Oracle AI Vector Search](overview-ai-vector-
...
query data based on semantics, rather than keywords.")). A vector embedding
model creates these embeddings by assigning numerical values to each element
of your data (such as a word, sentence, or paragraph).
...
[← Previous](your-vector-documentation-map-genai-prompts.md)
