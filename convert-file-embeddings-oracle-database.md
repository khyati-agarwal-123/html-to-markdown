[Previous](convert-file-text-chunks-embeddings-oracle-database.html) [Next](generate-and-use-embeddings-end-end-search.html) JavaScript must be enabled to correctly display this content 
...
For complete example, run [SQL Quick Start Using a Vector Embedding Model Uploaded into the Database](sql-quick-start-using-vector-embedding-model-uploaded-database.html#GUID-403EB84E-3047-4905-844C-BD4A8670B8A4 "A set of SQL commands is provided to run a particular scenario that will help you understand Oracle AI Vector Search capabilities."), where you can see how to embed Oracle Database Documentation books in the `doc_chunks` table and perform similarity searches using vector indexes. 
