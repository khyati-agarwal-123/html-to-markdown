[Previous](vector-helper-procedures.html) [Next](terms-using-vector-utility-pl-sql-packages.html) JavaScript must be enabled to correctly display this content 
