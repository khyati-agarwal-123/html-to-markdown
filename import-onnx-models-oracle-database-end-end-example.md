[Previous](python-classes-convert-pretrained-models-onnx-models.html)[Next](alternate-method-import-onnx-models.html) JavaScript must be enabled to
...
For more information about the `LOAD_ONNX_MODEL` procedure, see [Oracle
Database PL/SQL Packages and Types
Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-
database/23/vecse&id=ARPLS-GUID-7F1D7992-D8F7-4AD9-9BF6-6EFFC1B0617A).

Alternatively, if your ONNX embedding model is loaded on cloud object storage,
the `LOAD_ONNX_MODEL_CLOUD` procedure can be used. For more information, see
...
You can view model attributes and learn about the model by querying machine
...
[USER_MINING_MODEL_ATTRIBUTES](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-
...
[USER_MINING_MODELS](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-
database/23/vecse&id=REFRN-
...
Models](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-
...
To learn about the `VECTOR_EMBEDDING` SQL function, see
[VECTOR_EMBEDDING](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/vecse&id=SQLRF-GUID-5ED78260-6D21-4B6B-86E0-A1E70EFA11CA). You can
...
SQL](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-
