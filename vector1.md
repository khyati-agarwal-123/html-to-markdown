[Previous](to_vector.html) [Next](vector-serializers.html) JavaScript must be enabled to correctly display this content 
...
![Description of vector_vecse.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_vecse.gif)[Descriptionof the illustration vector_vecse.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/vector_vecse.html)
