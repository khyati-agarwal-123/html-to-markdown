[Previous](query-data-similarity-and-hybrid-searches.html) [Next](perform-approximate-similarity-search-using-vector-indexes.html) JavaScript must be
...
follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/flat-index.png)[Description of "Figure 8-1 Exact
Search"](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/flat-index.html)
