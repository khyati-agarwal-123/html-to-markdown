[Previous](overview-node.html) [Next](why-use-vector-search-instead-other-vector-databases.html) JavaScript must be enabled to correctly display this
content
...
follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_embeddings.png)[Description of the illustration
vector_embeddings.eps](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/vector_embeddings.html)
...
follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_embeddings_similarity.png)[Description of the illustration
vector_embeddings_similarity.eps](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/vector_embeddings_similarity.html)
...
follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_embeddings_similarity_search.png)[Description of the illustration
vector_embeddings_similarity_search.eps](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/vector_embeddings_similarity_search.html)
...
follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/basic_transform.png)[Description of "Figure 2-1 Vector Embedding
Model"](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/basic_transform.html)
...
node.html#GUID-A788574C-F88D-4E5E-B220-A40FA8CBB174 "Oracle AI Vector Search
