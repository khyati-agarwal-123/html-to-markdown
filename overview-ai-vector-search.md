[Previous](overview-node.html) [Next](why-use-vector-search-instead-other-vector-databases.html) JavaScript must be enabled to correctly display this content 
...
![Description of vector_embeddings.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_embeddings.png)[Descriptionof the illustration vector_embeddings.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/vector_embeddings.html)
...
![Description of vector_embeddings_similarity.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_embeddings_similarity.png)[Descriptionof the illustration vector_embeddings_similarity.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/vector_embeddings_similarity.html)
...
![Description of vector_embeddings_similarity_search.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_embeddings_similarity_search.png)[Descriptionof the illustration vector_embeddings_similarity_search.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/vector_embeddings_similarity_search.html)
...
![Description of Figure 2-1 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/basic_transform.png)[Descriptionof "Figure 2-1 Vector Embedding Model"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/basic_transform.html)
