[Previous](vector-memory-pool-views.html) [Next](vector-index-and-hybrid-vector-index-views.html) JavaScript must be enabled to correctly display this content 

  1. [AI Vector Search User's Guide](index.html)2. [Vector Diagnostics](vector-diagnostics-node.html)
  3. [Oracle AI Vector Search Views](oracle-ai-vector-search-views.html)4. [Vector Memory Pool Views](vector-memory-pool-views.html)
...
**Parent topic:** [Vector Memory Pool Views](vector-memory-pool-views.html "Review the various vector memory pool views.")

[← Previous](vector-memory-pool-views.md)

[Next →](vector-index-and-hybrid-vector-index-views.md)
