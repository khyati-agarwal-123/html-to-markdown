[Previous](store-vector-embeddings.html) [Next](insert-vectors-database-table-using-insert-statement.html) JavaScript must be enabled to correctly display this content 
...
**Parent topic:** [Store Vector Embeddings](store-vector-embeddings.html "Store vector embeddings and associated unstructured data with your relational business data in Oracle Database.")
