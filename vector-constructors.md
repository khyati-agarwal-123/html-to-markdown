[Previous](constructors-converters-descriptors-and-arithmetic-functions.html)[Next](to_vector.html) JavaScript must be enabled to correctly display this
content
...
converters-descriptors-and-arithmetic-functions.html "Other basic vector
