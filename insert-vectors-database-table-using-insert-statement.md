[Previous](create-tables-using-vector-data-type.html) [Next](load-vector-data-using-sqlloader.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [Convert Text String to Embedding Within Oracle Database](convert-text-string-embedding-oracle-database.html#GUID-1F9E9C73-6118-427E-8FB7-D4EBCCECC6D0 "Perform a text-to-embedding transformation by accessing a vector embedding model stored in the database.")
