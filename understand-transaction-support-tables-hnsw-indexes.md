[Previous](understand-hierarchical-navigable-small-world-indexes.html) [Next](understand-hnsw-index-population-mechanisms-oracle-rac-and-single-instance.html) JavaScript must be enabled to correctly display this content 
...
![Description of hnsw_index_with_private_and_shared_journal.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/hnsw_index_with_private_and_shared_journal.png)[Descriptionof the illustration hnsw_index_with_private_and_shared_journal.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/hnsw_index_with_private_and_shared_journal.html)
...
![Description of hnsw_repopulation.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/hnsw_repopulation.png)[Descriptionof the illustration hnsw_repopulation.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/hnsw_repopulation.html)
