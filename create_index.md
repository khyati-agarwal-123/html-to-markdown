[Previous](create_credential-dbms_vector.html) [Next](disable_checkpoint.html)
...
To create a vector index such as Hierarchical Navigable Small World (HNSW)
vector index or Inverted File Flat (IVF) vector index.
