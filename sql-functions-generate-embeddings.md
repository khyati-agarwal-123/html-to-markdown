[Previous](understand-stages-data-transformations.html) [Next](pl-sql-packages-generate-embeddings.html) JavaScript must be enabled to correctly
...
"Use VECTOR_EMBEDDING to generate a single vector embedding for different data
types using embedding or feature extraction machine learning models.").
